...
GameStore.dispatchToken = register(action=>{
	...
	switch(action.type){
		...
		case 'GAME10_OFFLINE_INIT_GAME':
			...
			GameStore.emitAndSaveChange( 'gameData', _game );
			break;
		case 'GAME10_OFFLINE_INIT_START_GAME':
			...
			GameStore.emitAndSaveChange( 'gameData', _game );
			break;
		case 'GAME10_OFFLINE_INIT_ROUND':
			GameStore.initRound();
			GameStore.setCardPositionByState();
		...
		case 'GAME10_OFFLINE_DISTRIBUTE_CARDS':
			...
			break;
		case 'GAME10_OFFLINE_DISTRIBUTE_CARDS_SUCCESS':
			GameStore.distributionDone();
			GameStore.setGameState('NOW_NEXT_TURN');
			GameStore.fireNextTurn();
			GameStore.saveChange( 'gameData', _game );
			break;
		case 'GAME10_OFFLINE_BOT_HAS_PLAYED':
			GameStore.playBot();
			break;
		case 'GAME10_OFFLINE_PLAY_CARD':
			...
			break;
		case 'GAME10_OFFLINE_PLAY_CARD_SUCCESS':
			...
			break;
		case 'GAME10_OFFLINE_SKIP_TURN':
			passAudio.play();
			GameStore.emitChange();
			break;
		 case 'GAME10_OFFLINE_TURN_SKIPPED':
		 	GameStore.setGameState('NOW_NEXT_TURN');
		 	GameStore.fireNextTurn();	
			GameStore.saveChange( 'gameData', _game );
		 	break;
		 case 'GAME10_OFFLINE_NOW_NEXT_TURN':
		 	GameStore.nextTurn();
			GameStore.updatePlayersArray();
			...
			.then(function(){
		 	...
		 	break;
		 case 'GAME10_OFFLINE_SHOW_SCORES':
		 	GameStore.showScores();
			GameStore.setRoundEndPos();
			GameStore.setGameState('ROUND_END_SHOW_SCORES');
			GameStore.emitChange();
		 	break;
		 case 'GAME_10_OFFLINE_HIDE_SCORE_UPDATED':
