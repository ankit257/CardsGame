...
game325.prototype.init = function(){
	for (var i = this.maxPlayers - 1; i >= 0; i--) {
...
game325.prototype.assignActivePlayer = function(){
	for (var i = this.players.length - 1; i >= 0; i--) {
...
game325.prototype.playCardDummy = function(){
	var card = this.cardPlayed;
	for (var i = 0; i < this.players.length ; i++) {
		if(this.players[i].id == this.activePlayerId){
			this.players[i].cardPlayedDummy = card;
...
game325.prototype.getTurnWinner = function() {
	...
	for (var i = 0; i < this.players.length ; i++) {
		if(!this.players[i].cardPlayedDummy.suit){
			 this.players[i].cardPlayedDummy = this.cardPlayed;
		}
	}
	var biggestCard = null;
	for (var i = 0; i < this.players.length; i++){
		biggestCard = getBiggestCard(biggestCard, this.players[i].cardPlayedDummy, this.turnSuit, this.trump);
	}
	this.turnSuit = '';
	for (var i = 0; i < this.players.length; i++) {
		if(this.players[i].cardPlayedDummy == biggestCard){
	...
	for (var i = 0; i < this.players.length ; i++) {
			 this.players[i].cardPlayedDummy = '';
	}
